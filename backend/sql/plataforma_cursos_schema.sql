-- =============================================================================
-- Esquema completo MySQL — Plataforma de cursos
-- Esquema único para nuevas instalaciones (también lo usa npm run db:init)
-- Charset recomendado: utf8mb4
--
-- Uso (línea de comandos):
--   mysql -u root -p < backend/sql/plataforma_cursos_schema.sql
-- O en Workbench: abrir este archivo y ejecutar todo el script.
-- =============================================================================
...
-- ----------------------------------------------------------------------------- sections (antes de videos por FK section_id)
